...
// 		entities.WIP9[1],
// 		token0,
// 		entities.FromRawAmount(entities.WIP9[1], big.NewInt(100000)),
// 		entities.FromRawAmount(token0, big.NewInt(100000)),
// 		constants.FeeMedium,
// 	)
...
// 	assert.Equal(t, result[0].Swaps[0].Route.TokenPath, []*entities.Token{entities.WIP9[1], token0, token1, token3})
// 	assert.Equal(t, result[0].OutputAmount().Currency, token3)
// 	assert.Equal(t, result[1].InputAmount().Currency, Ether)
// 	assert.Equal(t, result[1].Swaps[0].Route.TokenPath, []*entities.Token{entities.WIP9[1], token0, token3})
...
// 	assert.Equal(t, result[0].Swaps[0].Route.TokenPath, []*entities.Token{token3, token0, entities.WIP9[1]})
// 	assert.Equal(t, result[0].OutputAmount().Currency, Ether)
// 	assert.Equal(t, result[1].InputAmount().Currency, token3)
// 	assert.Equal(t, result[1].Swaps[0].Route.TokenPath, []*entities.Token{token3, token1, token0, entities.WIP9[1]})
